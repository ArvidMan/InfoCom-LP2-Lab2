...
# ===============================================
redis_server = redis.Redis(host = '0.0.0.0', port=7777)
# ===============================================
...
def moveDrone(d_long, d_la):
    longitude = float(redis_server.get('longitude').decode('utf-8'))
    latitude  = float(redis_server.get('latitude').decode('utf-8'))
